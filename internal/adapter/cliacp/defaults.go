...
func Defaults() []DefaultAgent {
	return []DefaultAgent{
		...
		{ID: "claude-acp", Name: "Claude Agent", Command: "npx", Protocol: "acp", Args: []string{"-y", "@agentclientprotocol/claude-agent-acp@0.32.0"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "0.32.0"},
		...
		{ID: "codex-acp", Name: "Codex ACP", Command: "npx", Protocol: "acp", Args: []string{"-y", "@zed-industries/codex-acp@0.13.0"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "0.13.0"},
		...
		{ID: "dirac", Name: "Dirac", Command: "npx", Protocol: "acp", Args: []string{"-y", "dirac-cli@0.3.40", "--acp"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "0.3.40"},
		{ID: "factory-droid", Name: "Factory Droid", Command: "npx", Protocol: "acp", Args: []string{"-y", "droid@0.120.1", "exec", "--output-format", "acp-daemon"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "0.120.1"},
		{ID: "github-copilot-cli", Name: "GitHub Copilot", Command: "npx", Protocol: "acp", Args: []string{"-y", "@github/copilot@1.0.43", "--acp"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "1.0.43"},
		...
		{ID: "nova", Name: "Nova", Command: "npx", Protocol: "acp", Args: []string{"-y", "@compass-ai/nova@1.1.5", "acp"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "1.1.5"},
		...
		{ID: "qoder", Name: "Qoder CLI", Command: "npx", Protocol: "acp", Args: []string{"-y", "@qoder-ai/qodercli@0.2.8", "--acp"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "0.2.8"},
		{ID: "qwen-code", Name: "Qwen Code", Command: "npx", Protocol: "acp", Args: []string{"-y", "@qwen-code/qwen-code@0.15.8", "--acp", "--experimental-skills"}, AuthStatus: "Runnable through ACP registry package", Source: "ACP registry", Version: "0.15.8"},
